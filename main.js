    // main.js
    // File ini berisi semua logika aplikasi utama.

    // Mengimpor array produk dari products.js
    ...
    // Share button elements in modal
    ...
    const openOrderModal = (productId) => {
        ...
        if (selectedProduct) {
            ...
            // PENTING: BARIS INI YANG MEMBUAT LINK DENGAN ID PRODUK
